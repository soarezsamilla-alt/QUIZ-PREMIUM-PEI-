      ...
      <DialogContent className="max-w-[90vw] sm:max-w-[400px] rounded-[24px] p-0 overflow-hidden border-none shadow-2xl focus:outline-none">
        ...
        <div className="bg-white p-6 pt-8 relative">
          ...
          <div className="flex flex-col gap-4">
            <Button asChild className="w-[90%] mx-auto h-auto py-3 bg-gradient-to-br from-rose to-rose-deep text-white font-black text-xs rounded-full shadow-xl hover:scale-[1.02] transition-all btn-mobile-effect border-none">
